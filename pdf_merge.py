...
pdf_listbox = tk.Listbox(root, selectmode=tk.SINGLE, bg='black', fg='white', width=100, height=20)
...
# Create buttons with larger gaps and text padding
