...
class ImageDisplayApp:
    def __init__(self, master):
        ...
        self.left_frame = tk.Frame(self.master, bg="black")  # Set background color to black
        self.left_frame.pack(side=tk.LEFT, padx=(0,200))

        self.right_frame = tk.Frame(self.master, bg="black")  # Set background color to black
        self.right_frame.pack(side=tk.RIGHT, padx=10)

        # Create Canvas to display images in the left frame
        self.canvas = tk.Canvas(self.left_frame, width=650, height=800, bg="black")  # Set background color to black
        ...
        self.image_frame = tk.Frame(self.canvas, bg="black")  # Set background color to black
        self.canvas.create_window((0, 0), window=self.image_frame, anchor="nw")

        # Create Listbox to display image names in the right frame
        self.listbox = tk.Listbox(self.right_frame, selectmode=tk.SINGLE, width=30, height=20, bg="black", fg="white", selectbackground="blue")
